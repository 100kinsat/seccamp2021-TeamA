...
void MySD::createDir(fs::FS &fs, const char * path){
...
void MySD::removeDir(fs::FS &fs, const char * path){
...
void MySD::readFile(fs::FS &fs, const char * path){
...
void MySD::writeFile(fs::FS &fs, const char * path, const char * message){
...
void MySD::renameFile(fs::FS &fs, const char * path1, const char * path2){
...
void MySD::deleteFile(fs::FS &fs, const char * path){
...
void MySD::testFileIO(fs::FS &fs, const char * path){
    File file = fs.open(path);
